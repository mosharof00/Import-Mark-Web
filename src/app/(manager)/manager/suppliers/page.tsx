...
import type { SupplierFilter } from "@/app/(admin)/admin/suppliers/_components/supplier-filters"
import {
...
export default async function ManagerSuppliersPage({
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Suppliers"
        description="View import partners — contact details, shipment history, and outstanding payables."
      />
