  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormSection
          title="Pricing & unit"
          description="How this product is sold to customers."
        >
          <FormField
            control={form.control}
            name="sellPrice"
        ...
        <FormSection
          ...
          description="Quantity is adjusted from Inventory. Update the alert threshold here."
        >
          <FormItem>
            ...
            <FormDescription>
              To change quantity, use Inventory → Adjust on this product.
            </FormDescription>
          </FormItem>
          <FormField
            control={form.control}
