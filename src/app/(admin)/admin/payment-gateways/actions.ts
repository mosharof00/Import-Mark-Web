...
function revalidateGatewayPaths(gatewayId?: string) {
  ...
  if (gatewayId) {
    revalidatePath(`/admin/payment-gateways/${gatewayId}`)
    revalidatePath(`/admin/payment-gateways/${gatewayId}/edit`)
...
export async function createPaymentGateway(
  ...
  redirect(`/admin/payment-gateways/${gateway.id}`)
}
...
export async function updatePaymentGateway(
  ...
  redirect(`/admin/payment-gateways/${parsed.data.id}`)
}
