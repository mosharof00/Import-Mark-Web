...
import { PlaceOrderWizard } from "@/app/(manager)/manager/orders/new/_components/place-order-wizard"
import type {
  CategoryOption,
  WizardAddress,
  WizardCustomer,
...
export default async function AdminPlaceOrderPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Place Order"
        description="Create a sales order for a customer. Advance payment and proof can be recorded now."
      />
      <PlaceOrderWizard
        customers={customers}
        products={products}
