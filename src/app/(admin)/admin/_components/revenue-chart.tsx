...
export type RevenuePoint = {
  /** ISO day key, e.g. "2026-06-05" */
  day: string
  /** Short label for the x-axis, e.g. "5 Jun" */
  label: string
  revenue: number
}
...
export async function RevenueChart() {
  ...
  try {
    ...
    // Pre-fill 30 empty buckets so the chart always spans the full range.
    ...
    return <ErrorCard title="Couldn't load revenue chart" />
  }
}
